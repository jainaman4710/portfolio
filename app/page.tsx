    ...
    <div className="min-h-screen" style={{ backgroundColor: "#FFF5F7" }}>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(circle, #F8BBD9 1px, transparent 1px)",
        ...
        <div className="relative z-10 px-20 py-16 max-w-[660px]">
          ...
          <p
            ...
            style={{ fontSize: "12px", letterSpacing: "0.1em", color: "#b0a0b4" }}
          >
            Mechanical Engineering &middot; IIT Kharagpur
          </p>
          <p
            className="leading-[1.85] max-w-[520px] mb-8"
            style={{ fontSize: "15px", color: "#6b5b6e" }}
          >
      ...
      >
        <div>
          ...
          <h2 className="font-serif font-normal mb-8" style={{ fontSize: "clamp(1.9rem,2.8vw,2.6rem)", color: "#1a1a2e" }}>
            About Me
          </h2>
          <div style={{ fontSize: "15px", color: "#6b5b6e", lineHeight: "1.9" }}>
            ...
            <p>
              I&apos;ve interned as a{" "}
              <strong style={{ color: "#1a1a2e", fontWeight: 500 }}>Product Management Intern at DevLaunch</strong>,
              ...
              <strong style={{ color: "#1a1a2e", fontWeight: 500 }}>Business Analyst Intern at SCMYuga Technologies</strong>,
      ...
      <section id="education" className="px-20 py-20" style={{ backgroundColor: "#FFF5F7" }}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2 rounded-2xl p-8" style={{ background: "#fff", border: "1px solid #F8BBD9" }}>
            ...
            <p className="font-medium mb-1" style={{ fontSize: "14px", color: "#1a1a2e" }}>
            ...
            <p className="font-mono uppercase mb-3" style={{ fontSize: "10px", color: "#b0a0b4", letterSpacing: "0.08em" }}>
              Relevant Courses
            </p>
            <div className="flex flex-wrap gap-2">
              {courses.map((c) => (
                <span
                  ...
                  style={{ fontSize: "12px", color: "#9C27B0", background: "#F3E5F5", border: "1px solid #CE93D8", padding: "3px 11px" }}
                >
                  {c}
                </span>
              ))}
          ...
          {/* Class XII */}
          <div className="rounded-2xl p-8" style={{ background: "#fff", border: "1px solid #F8BBD9" }}>
            <span
              className="font-mono uppercase inline-block rounded-full mb-4"
              style={{ fontSize: "10px", color: "#303F9F", background: "#E8EAF6", border: "1px solid #9FA8DA", padding: "3px 10px", letterSpacing: "0.06em" }}
            >
      ...
      <section id="contact" className="px-20 py-28 text-center" style={{ backgroundColor: "#FFF5F7" }}>
        ...
        <h2 className="font-serif font-normal mb-3" style={{ fontSize: "clamp(1.9rem,2.8vw,2.6rem)", color: "#1a1a2e" }}>
          Contact
        </h2>
        ...
        <div className="flex gap-6">
          {["home","projects","about","education","skills","contact"].map((l) => (
            <a
              key={l}
              href={`#${l}`}
              className="font-mono capitalize no-underline"
